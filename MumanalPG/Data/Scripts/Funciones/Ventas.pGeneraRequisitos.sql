...
AS $$
    INSERT INTO "Ventas"."VentaRequisito" 
         ("IdVentaContratacion", "IdBeneficiario", "IdDocumentoRespaldo", "IdDocumentoFormato", "DocumentoEntregado", "PathArchivo", "ArchivoCargado", "IdEstadoRegistro", "IdUsuario", "FechaRegistro")
    select IdVentaContratacion , 0               , "IdDocumentoRespaldo", 0                   , 'f'                 , ''           , 'f'             , 1                 , 1          , now()

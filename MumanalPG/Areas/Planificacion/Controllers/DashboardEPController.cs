...
namespace MumanalPG.Areas.Planificacion.Controllers
{
    ...
    [Authorize]
    [Area("Planificacion")]
    public class DashboardEPController : BaseController
    {        
		public DashboardEPController(ApplicationDbContext db): base(db)
        {
        }
        ...
        [Breadcrumb("EstructuraProgramatica", FromAction = "Index")]

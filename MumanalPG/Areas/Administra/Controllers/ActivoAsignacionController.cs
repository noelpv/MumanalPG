    ...
    public class ActivoAsignacionController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var activoAsignacion = await _context.ActivoAsignacion
                .FirstOrDefaultAsync(m => m.IdActivoAsignacion == id);
        ...
        public async Task<IActionResult> Create([Bind("IdActivoAsignacion, IdActivoFijo, IdBeneficiarioOrigen, IdBeneficiario, IdUnidadEjecutora, IdUnidadEjecutoraDestino, IdEstadoRegistro, IdUsuario, FechaRegistro")] ActivoAsignacion activoAsignacion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdActivoAsignacion, IdActivoFijo, IdBeneficiarioOrigen, IdBeneficiario, IdUnidadEjecutora, IdUnidadEjecutoraDestino, IdEstadoRegistro, IdUsuario, FechaRegistro")] ActivoAsignacion activoAsignacion)
        {
            if (id != activoAsignacion.IdActivoAsignacion)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ActivoAsignacionExists(activoAsignacion.IdActivoAsignacion))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.ActivoAsignacion.Any(e => e.IdActivoAsignacion == id);
        }
    }
}
